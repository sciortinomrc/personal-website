...
exports.fold = (e, whichLabel) => {
    console.log(lastRequest + 1000, Date.now() , lastRequest + 1000 > Date.now())
...
window.isInViewport=(element) => {
    ...
    // console.log("rt", rect.top, "rb", rect.bottom)
    // console.log("t", document.documentElement.scrollTop, "b",document.documentElement.scrollTop + document.documentElement.clientHeight)
    console.log(element.id,  rect.bottom / document.documentElement.clientHeight  )
    return (
