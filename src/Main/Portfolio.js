		...
		<div id="portfolio" class="text-center" >
			<h2 className="text-custom-2">My Work</h2>
				<div class="d-flex flex-wrap justify-content-center">
					<a href="https://pagesify.mrcdev.co.uk" class="m-4" target="_blank"  rel="noopener noreferrer" >
						<div className="description">
							<h4>Pagesify - Facebook pages showcase</h4>
							<ul>
								<li>- Front end: React - Redux - CSS</li>
								<li>- Back end: ExpressJS - MySQL - AI</li>
							</ul>
						</div>
						<div>
					...
					<a href="https://mrcdev.co.uk/apps/my_cool_calendar/" class="m-4" target="_blank"  rel="noopener noreferrer">
						<div className="description">
					...
					<a href="https://mrcdev.co.uk/apps/matching_game/" class="m-4" target="_blank"  rel="noopener noreferrer">
						<div className="description">
							<h4>Matching game</h4>
							<ul>
